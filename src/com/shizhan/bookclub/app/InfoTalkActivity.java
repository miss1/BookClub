...
public class InfoTalkActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		query.findObjects(InfoTalkActivity.this, new FindListener<Post>() {
			...
			public void onSuccess(List<Post> arg0) {
				...
				adapter = new FindAllAdapter(InfoTalkActivity.this, inpost);
			...
			public void onError(int arg0, String arg1) {
				adapter = new FindAllAdapter(InfoTalkActivity.this, inpost);
				Toast.makeText(InfoTalkActivity.this, arg1, Toast.LENGTH_SHORT).show();
				infoTalkList.setAdapter(adapter);
			}
		});
	...
	public static void actionStart(Context context, MyUsers user) {
		Intent intent = new Intent(context, InfoTalkActivity.class);
		...
		infoTalkList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(inpost.size()!=0){
					...
					NewsCommentActivity.actionStart(InfoTalkActivity.this, post);
				}
